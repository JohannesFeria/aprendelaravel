...
<script RunAt="server">
    ...
    'Descripcion: Se agrega Customer.js
    Sub Application_Start(ByVal sender As Object, ByVal e As EventArgs)
        ...
        jsFiles = New String() {"~/App_Themes/js/jquery.js",
                                "~/App_Themes/js/jquery.min.js",
                                "~/App_Themes/js/bootstrap.js",
                                "~/App_Themes/js/zoluxiones.js",
                                "~/App_Themes/js/ChartJS.js",
                                "~/App_Themes/js/hammerjs.js",
                                "~/App_Themes/js/chartjs-plugin-zoom.js",
                                "~/App_Themes/js/Customer.js",
        ...
        cssFiles = New String() {"~/App_Themes/css/bootstrap.css",
                                 ...
                                 "~/App_Themes/css/jquery/jquery-ui.min.css"}
    ...
    Sub Application_Error(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If (TypeOf exc Is HttpUnhandledException) Then
            ...
            End If
        End If
        Server.Transfer("~/frmError.aspx?handler=Application_Error%20-%20Global.asax", True)
    End Sub
