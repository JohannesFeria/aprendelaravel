...
var PRESERVESTATE = 0;
//var ICONPATH = 'App_Themes/Imgenes/Menu/';          //PARA SETEAR LOS ICONOS DEL TREVIEW :)
var ICONPATH = '';          //PARA SETEAR LOS ICONOS DEL TREVIEW :)

var HIGHLIGHT = 0;
var HIGHLIGHT_COLOR = 'black';
var HIGHLIGHT_BG    = '#6699cc'                     //PARA SETEAR EL COLOR DE LA SELECCION DE LOS ICONOS
var BUILDALL = 0;
var GLOBALTARGET = "R"; // variable only applicable for addChildren uses

var Iconos_FolderCerrado = "ftv2folderclosed.bmp";
var Iconos_FolderAbierto = "ftv2folderopen.bmp";
var Iconos_Formulario = "ftv2doc.bmp";
...
{ 
  ...
  this.iconImg = 0; 
  this.nodeImg = 0;
  this.iconSrc = ICONPATH + Iconos_FolderAbierto;
  this.iconSrcClosed = ICONPATH + Iconos_FolderCerrado;
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + Iconos_Formulario 
...
function preLoadIcons() {
       arImageSrc = new Array (
           ...
           "ftv2lastnode.gif",
           "ftv2node.gif",
           Iconos_FolderCerrado,
           Iconos_FolderAbierto,
           Iconos_Formulario
           )
