<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmInterfaseLineaxContraparteFWD.aspx.vb" Inherits="Modulos_Gestion_Archivos_Planos_frmInterfaseLineaxContraparteFWD" %>
...
<body>
    ...
    <div class="container-fluid">
        <header>
            <h2>
                Importar para Líneas por Contraparte para Forwards
            </h2>
        </header>
        <br />
        <fieldset>
