<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmInterfaseLineasContraparte.aspx.vb" Inherits="Modulos_Gestion_Archivos_Planos_frmInterfaseLineasContraparte" %>
...
<head id="Head1" runat="server">
    <title>Interfase Contraparte</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <header>
            <h2>
                Importar para Líneas por Contraparte
            </h2>
        </header>
        <br />
        <fieldset>
