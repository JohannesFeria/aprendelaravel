<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFlujoCajaExterior.aspx.vb"
    Inherits="Modulos_Tesoreria_FlujoCajaEstimado_frmFlujoCajaExterior" %>
...
<head id="Head1" runat="server">
    <title>Flujo de Caja Exterior</title>
</head>
<body>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-append date">
                                <asp:TextBox runat="server" ID="tbFechaVcto" SkinID="Date" />
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 control-label" style="text-align:left;">
                            ...
                            <asp:RadioButton Text="Años" runat="server" ID="rbtMeses" GroupName="rbtPeriodo" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <asp:DropDownList ID="ddlTipoFlujo" runat="server" Width="130px" Visible="False">
