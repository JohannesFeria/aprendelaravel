<%@ Page Language="VB" AutoEventWireup="True" CodeFile="frmLetrasHipotecarias.aspx.vb" Inherits="Modulos_Inversiones_InstrumentosNegociados_frmLetrasHipotecarias" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function cambiaTitulo() {
            ...
            document.getElementById("lblTitulo").innerHTML = 'Letras Hipotecarias';
        ...
        function Salida() {
            ...
            if (strAccion != "") {
                ...
                strMensaje = "¿Desea cancelar " + strAccion + " de la Orden de Inversión de Letras Hipotecarias?"
    ...
    <div class="container-fluid">
        <header>
            <div class="row">
                <div class="col-md-6">
                    <h2>
                        <asp:Label ID="lblTitulo" Text="Letras Hipotecarias" runat="server" /></h2>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <asp:TextBox runat="server" ID="txtMnomOrd" Width="150px" CssClass="Numbox-7_12" ReadOnly="True" />
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="col-sm-6 control-label">
                                Bolsa</label>
                            <div class="col-sm-6">
                                <asp:DropDownList ID="ddlPlaza" runat="server" AutoPostBack="True" Width="150px">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
