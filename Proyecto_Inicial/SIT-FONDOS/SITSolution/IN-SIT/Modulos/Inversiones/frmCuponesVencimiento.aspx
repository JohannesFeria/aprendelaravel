<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCuponesVencimiento.aspx.vb" Inherits="Modulos_Inversiones_frmCuponesVencimiento" %>
...
<body>
    ...
    <br />
    <div class="grilla">
        <asp:GridView ID="dgLista" runat="server" AutoGenerateColumns="False" SkinID="GridFooter">            
            <Columns>
                ...
                <asp:BoundField DataField="TasaNominal" HeaderText="Tasa Nominal" DataFormatString="{0:#,##0.0000000}" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                <asp:BoundField DataField="ValorNominalLocal" HeaderText="ValorNominalLocal" DataFormatString="{0:#,##0.0000000}" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                ...
                <asp:BoundField FooterStyle-CssClass="hidden" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden" DataField="Secuencia" HeaderText="CodigoNemonico"></asp:BoundField>
            </Columns>
        </asp:GridView>
    </div>
    <br />
