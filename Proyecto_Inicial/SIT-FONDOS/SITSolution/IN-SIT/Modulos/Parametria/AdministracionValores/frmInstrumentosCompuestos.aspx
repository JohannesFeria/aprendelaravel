<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmInstrumentosCompuestos.aspx.vb"
    Inherits="Modulos_Parametria_AdministracionValores_frmInstrumentosCompuestos" %>
...
<head id="Head1" runat="server">
    <title>Agrupaci&oacute;n de Instrumentos Compuestos</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <header>
            <div class="row">
                <div class="col-md-6">
                    <h2>
                        Agrupaci&oacute;n de Instrumentos Compuestos</h2>
                </div>
            </div>
        </header>
        <fieldset>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="tbRVteorico" Width="150px" ReadOnly="true" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <asp:TextBox runat="server" ID="tbRFteorico" Width="150px" ReadOnly="true" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <asp:TextBox runat="server" ID="tbMonto" Width="150px" />
                            <asp:RequiredFieldValidator ErrorMessage="Nominales" ControlToValidate="tbMonto"
                                runat="server" />
                        </div>
                    </div>
                </div>
        ...
        <div class="grilla-small">
            <asp:GridView runat="server" SkinID="GridSmall" ID="dgLista">
                <Columns>
                    ...
                    <asp:BoundField DataField="Emision" HeaderText="Emisi&oacute;n" />
                    <asp:BoundField DataField="Monto" HeaderText="Nominales" />
    ...
    <input id="hdValorUnitario" type="hidden" name="hdValorUnitario" runat="server">
