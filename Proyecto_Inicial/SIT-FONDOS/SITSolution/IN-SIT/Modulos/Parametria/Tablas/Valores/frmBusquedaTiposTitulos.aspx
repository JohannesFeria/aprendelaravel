<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaTiposTitulos.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Valores_frmBusquedaTiposTitulos" %>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            C&oacute;digo Tipo T&iacute;tulo</label>
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="tbCodigo" Width="250px" />
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:DropDownList runat="server" ID="ddlTipoInstrumento" Width="250px" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:DropDownList runat="server" ID="ddlSituacion" Width="250px" />
                        </div>
                    </div>
                </div>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoTipoTitulo") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoMoneda" HeaderText="C&#243;digo Moneda" />
                            <asp:BoundField DataField="NombreInstrumento" HeaderText="Tipo Instrumento" />
