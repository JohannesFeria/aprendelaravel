<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaTiposCupon.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Valores_frmBusquedaTiposCupon" %>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoTipoCupon") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoTipoCupon" HeaderText="C&#243;digo" />
