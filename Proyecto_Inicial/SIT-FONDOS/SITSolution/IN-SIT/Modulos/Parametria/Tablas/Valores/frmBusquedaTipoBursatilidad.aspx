<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaTipoBursatilidad.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Valores_frmBusquedaTipoBursatilidad" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="tbDescripcion" Width="280px" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoBursatilidad") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoBursatilidad" HeaderText="C&#243;digo Tipo Bursatilidad" />
