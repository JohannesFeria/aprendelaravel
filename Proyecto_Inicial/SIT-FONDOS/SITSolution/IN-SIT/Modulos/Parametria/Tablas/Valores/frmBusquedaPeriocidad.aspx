<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaPeriocidad.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Valores_frmBusquedaPeriocidad" %>
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Dias de Per&iacute;odo</label>
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="txtDias" CssClass="Numbox-0_5" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoPeriodicidad") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoPeriodicidad" HeaderText="C&#243;digo Periodicidad" />
                            <asp:BoundField DataField="Descripcion" HeaderText="Descripci&#243;n" />
                            <asp:BoundField DataField="DiasPeriodo" HeaderText="Dias de Periodo" />
