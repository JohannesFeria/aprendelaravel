<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaOperacion.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Entidades_frmBusquedaOperacion" %>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoOperacion") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoOperacion" HeaderText="C&#243;digo" />
