...
Partial Class Modulos_Parametria_Tablas_Entidades_frmBusquedaOperacion
    Inherits BasePage
...
#Region "/* Eventos de la Pagina */"
    ...
    Private Sub btnIngresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIngresar.Click
        Try
            Response.Redirect("frmOperacion.aspx")
        Catch ex As Exception
    ...
    Public Sub Modificar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            Response.Redirect("frmOperacion.aspx?codigo=" & e.CommandArgument.ToString())
        Catch ex As Exception
    ...
    Public Sub Eliminar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            ...
            oOperacionBM.Eliminar(strCodigo, DatosRequest)
            CargarGrilla()
        Catch ex As Exception
            AlertaJS("Ocurrió un error al Emilinar Registro")
        End Try        
    End Sub
...
#Region "/* Metodos Personalizados */"
    ...
    Private Sub CargarGrilla()
        ...
        Dim dtblDatos As DataTable = oOperacionBM.SeleccionarPorFiltro(tbDescripcion.Text.TrimStart.TrimEnd, strSituacion, DatosRequest).Tables(0)
