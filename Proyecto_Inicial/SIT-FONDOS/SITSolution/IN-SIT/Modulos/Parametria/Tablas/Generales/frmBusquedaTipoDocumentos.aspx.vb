...
Partial Class Modulos_Parametria_Tablas_Generales_frmBusquedaTipoDocumentos
    Inherits BasePage
...
#Region " /* Funciones Modificar */"
    Public Sub Modificar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            Response.Redirect("frmTipoDocumento.aspx?cod=" & e.CommandArgument)
        Catch ex As Exception
...
#Region " /* Funciones Eliminar */"
    Public Sub Eliminar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            ...
            oTipoDocumentoBM.Eliminar(codigo, DatosRequest)
            CargarGrilla()
        Catch ex As Exception
...
#Region " /* Funciones Personalizadas*/"
    Private Sub CargarGrilla()
        Dim oTipoDocumentoBM As New TipoDocumentoBM
        Dim dtblDatos As DataTable = oTipoDocumentoBM.SeleccionarPorFiltro(tbCodigo.Text.Trim, tbDescripcion.Text.TrimStart.TrimEnd, IIf(ddlSituacion.SelectedValue = "Todos", "", ddlSituacion.SelectedValue), DatosRequest).Tables(0)
...
#End Region
    ...
    Protected Sub dgLista_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles dgLista.PageIndexChanging
        Try
            ...
            CargarGrilla()
        Catch ex As Exception
            AlertaJS("Ocurrio un error en la Paginación")
        End Try
    End Sub
