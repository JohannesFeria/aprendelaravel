<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaAprobadorCarta.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Generales_frmBusquedaAprobadorCarta" %>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <asp:DropDownList runat="server" ID="ddlRol" Width="150px" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lbFirma" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Firma") %>'
                                        Visible="False">
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="TipoFirmante" HeaderText="Tipo Firmante" /><%--OT-10795--%>
