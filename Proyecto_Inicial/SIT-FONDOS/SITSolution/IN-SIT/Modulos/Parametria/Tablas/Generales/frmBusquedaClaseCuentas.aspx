<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaClaseCuentas.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_General_frmBusquedaClaseCuentas" %>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="txtCodigo" MaxLength="3" />
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Descripción</label>
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="txtDescripcion" MaxLength ="15" />
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
                    ...
                    <asp:GridView runat="server" ID="dgLista" SkinID="Grid">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="ibModificar" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoClaseCuenta") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoClaseCuenta" HeaderText="C&#243;digo" />
