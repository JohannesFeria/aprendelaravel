...
Partial Class Modulos_Parametria_Tablas_Generales_frmBusquedaPaises
    Inherits BasePage
...
#Region " /* Metodos de Pagina */"
    ...
    Private Sub btnIngresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIngresar.Click
        Try
            Response.Redirect("frmPais.aspx")
        Catch ex As Exception
...
#Region " /* Funciones Modificar */"
    Public Sub Modificar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            Response.Redirect("frmPais.aspx?cod=" & e.CommandArgument)
        Catch ex As Exception
...
#Region " /* Funciones Eliminar */"
    Public Sub Eliminar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            ...
            oPaisBM.Eliminar(codigo, DatosRequest)
            CargarGrilla()
        Catch ex As Exception
...
#Region " /* Funciones Personalizadas*/"
    Private Sub CargarGrilla()
        Dim oPaisBM As New PaisBM
        Dim dtblDatos As DataTable = oPaisBM.SeleccionarPorFiltro(tbCodigo.Text.Trim, tbNombre.Text.TrimStart.TrimEnd, IIf(ddlSituacion.SelectedValue = "Todos", "", ddlSituacion.SelectedValue), DatosRequest).Pais
