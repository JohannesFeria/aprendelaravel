<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaPaises.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Generales_frmBusquedaPaises" %>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoPais") %>'></asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="CodigoPais" HeaderText="C&#243;digo" />
