<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaCodigosPostales.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Generales_frmBusquedaCodigosPostales" %>
...
<head runat="server">
    <title>C&oacute;digos Postales</title>
</head>
<body>
                            ...
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoPostal") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
