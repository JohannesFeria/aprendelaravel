<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTiposRenta.aspx.vb" Inherits="Modulos_Parametria_Tablas_Generales_frmTiposRenta" %>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator ErrorMessage="Descripci&oacute;n"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Tipo Factor</label>
                        <div class="col-sm-8">
                            <asp:DropDownList runat="server" ID="ddlTipoFactor" Width="140px" />
                        </div>
                    </div>
                </div>
            </div>
