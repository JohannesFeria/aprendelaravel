<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPais.aspx.vb" Inherits="Modulos_Parametria_Tablas_Generales_frmPais" %>
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Para&iacute;so Fiscal</label>
                        <div class="col-sm-8">
                            <asp:DropDownList runat="server" ID="ddlParaiso" Width="140px" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Doble Imposici&oacute;n</label>
                        <div class="col-sm-8">
                            <asp:DropDownList runat="server" ID="ddlDobleImposicion" Width="140px" />
                        </div>
                    </div>
                </div>
            </div>
