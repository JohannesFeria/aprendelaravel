<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGrupoPorClaseInstrumento.aspx.vb" Inherits="Modulos_Parametria_Tablas_Limites_frmGrupoPorClaseInstrumento" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<%: System.Web.Optimization.Scripts.Render("~/JavaScript/MainScripts") %>
<%: System.Web.Optimization.Styles.Render("~/App_Themes/css/ZxEstilos") %>
<head runat="server">
    <title>Grupo po Tipo de Instrumento</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <header>
            <div class="row">
                <div class="col-md-6">
                    <h2>Grupo Tipo de Clase Instrumento</h2>
                </div>
            </div>
        </header>
        <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtcodigoclase" />
                                </div>
                            </div>
                        </div>
                    </div>
