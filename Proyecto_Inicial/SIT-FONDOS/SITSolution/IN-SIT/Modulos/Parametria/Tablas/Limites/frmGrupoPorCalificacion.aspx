<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGrupoPorCalificacion.aspx.vb" Inherits="Modulos_Parametria_Tablas_Limites_frmGrupoPorCalificacion" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<%: System.Web.Optimization.Scripts.Render("~/JavaScript/MainScripts") %>
<%: System.Web.Optimization.Styles.Render("~/App_Themes/css/ZxEstilos") %>
<head runat="server">
    <title>Grupo por Calificacion</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <header>
            <div class="row"><div class="col-md-6"><h2>Grupo por Calificacion</h2></div></div>
        </header>
        <fieldset>
            <legend></legend>
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        <label class="col-sm-8 control-label">Opciones de Agrupacion</label>
                        <div class="col-sm-4">
                            <asp:CheckBoxList ID="chklOpciones" runat="server">
                                <asp:ListItem Value="1">Aplica Local</asp:ListItem>
                                <asp:ListItem Value="2">Aplica DPZ</asp:ListItem>
                            </asp:CheckBoxList>
                        </div>
                    </div>
                </div>
