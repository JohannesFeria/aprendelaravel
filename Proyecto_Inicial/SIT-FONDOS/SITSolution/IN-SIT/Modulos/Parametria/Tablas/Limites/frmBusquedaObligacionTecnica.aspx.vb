...
Partial Class Modulos_Parametria_Tablas_Limites_frmBusquedaObligacionTecnica
    Inherits BasePage

    Private FechaObliacionTecnica As Decimal
    ...
    Protected Sub btnIngresar_Click(sender As Object, e As System.EventArgs) Handles btnIngresar.Click
        Try
            Response.Redirect("frmObligacionTecnica.aspx")
        Catch ex As Exception
    ...
    Private Sub CargarGrilla()
        Dim oObligacionTecnica As New ObligacionTecnicaBM
        Dim dt As DataTable
        Me.FechaObliacionTecnica = UIUtility.ConvertirFechaaDecimal(Me.txtFecha.Text)
        Me.descripcion = Me.txtDescripcion.Text
        dt = oObligacionTecnica.SeleccionarPorFiltro("", "", Me.descripcion, Me.FechaObliacionTecnica, "", DatosRequest).Tables(0)
    ...
    Public Sub Modificar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            Response.Redirect("frmObligacionTecnica.aspx?cod=" & e.CommandArgument)
        Catch ex As Exception
            AlertaJS(ex.Message)
        End Try
    End Sub
    ...
    Public Sub Eliminar(ByVal sender As Object, ByVal e As CommandEventArgs)
        Try
            ...
            oObligacionTecnicaBM.Eliminar(codigo, DatosRequest)
            CargarGrilla()
        Catch ex As Exception
    ...
    Protected Sub btnImportar_Click(sender As Object, e As System.EventArgs) Handles btnImportar.Click
        Try
            Response.Redirect("frmObligacionTecnicaImportar.aspx")
        Catch ex As Exception
