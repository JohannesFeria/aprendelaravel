<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGrupoPorDerivados.aspx.vb" Inherits="Modulos_Parametria_Tablas_Limites_frmGrupoPorDerivados" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<%: System.Web.Optimization.Scripts.Render("~/JavaScript/MainScripts") %>
<%: System.Web.Optimization.Styles.Render("~/App_Themes/css/ZxEstilos") %>
<head runat="server">
    <title>Grupo por Tipo de Derivados</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <header>
            <div class="row">
                <div class="col-md-6"><h2>Grupo Tipo de Derivados</h2></div>
            </div>
        </header>
        <fieldset>
            <legend></legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <asp:CheckBoxList ID="chklOpciones" runat="server">
                                ...
                                <asp:ListItem Value="3">Aplica Swap</asp:ListItem>
                                <asp:ListItem Value="4">Aplica NominalRecibir</asp:ListItem>
                            </asp:CheckBoxList>
                        </div>
                    </div>
                </div>
