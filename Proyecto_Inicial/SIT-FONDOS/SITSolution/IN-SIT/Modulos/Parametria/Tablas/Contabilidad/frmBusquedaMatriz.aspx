<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusquedaMatriz.aspx.vb"
    Inherits="Modulos_Parametria_Tablas_Contabilidad_frmBusquedaMatriz" %>
                ...
                <ContentTemplate>
                    <asp:GridView runat="server" SkinID="Grid" ID="dgLista">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnModificar" runat="server" SkinID="imgEdit" OnCommand="Modificar"
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodigoMatrizContable") %>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="25px">
                            ...
                            <asp:BoundField DataField="CodigoMatrizContable" HeaderText="C&#243;digo" />
