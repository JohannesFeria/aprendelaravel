<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRol.aspx.vb" Inherits="Modulos_Menu_frmRol" %>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Nombre Rol</label>
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="tbNombreRol" />
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hfCodAplicativo" runat="server" Value='<%# Eval("CODIGO_APLICATIVO") %>' />
                            ...
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibMenu" runat="server" SkinID="imgMenu" OnCommand="Menu"
                                        CommandArgument='<%#Container.DataItemIndex%>'>
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="CODIGO_ROL" HeaderText="Codigo Rol" ItemStyle-Width="80px" />
                            <asp:BoundField DataField="NOMBRE_ROL" HeaderText="Descripci&#243;n" />
