...
Imports System.Data
Partial Class Modulos_ValorizacionCustodia_Custodia_Reportes_frmInstrumentosNoRegistrados
    Inherits BasePage
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try            
            ...
            rep.Load(Server.MapPath("InstrumentosNoRegistrados.rpt"))
            Dim oInstNoregTMP As DataSet = New CustodioArchivoBM().InstrumentosNoRegistrados(nFechaOperacion, sPortafolioCodigo, sCodigoCustodio, DatosRequest)
        ...
        End Try
    End Sub
    Protected Sub Modulos_ValorizacionCustodia_Custodia_Reportes_frmInstrumentosNoRegistrados_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
        rep.Close()
        rep.Dispose()
    End Sub
End Class