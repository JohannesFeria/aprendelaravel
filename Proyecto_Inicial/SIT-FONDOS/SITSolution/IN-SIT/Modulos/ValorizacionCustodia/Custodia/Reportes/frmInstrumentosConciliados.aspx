<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmInstrumentosConciliados.aspx.vb" Inherits="Modulos_ValorizacionCustodia_Custodia_Reportes_frmInstrumentosConciliados" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <cr1:CrystalReportViewer ID="crConciliados" runat="server"></cr1:CrystalReportViewer>
        </div>
    </div>
    </form>
</body>
