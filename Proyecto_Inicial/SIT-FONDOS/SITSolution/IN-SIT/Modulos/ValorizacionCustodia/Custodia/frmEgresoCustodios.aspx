<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEgresoCustodios.aspx.vb"
    Inherits="Modulos_Valorizacion_y_Custodia_Custodia_frmEgresoCustodios" %>
...
<head id="Head1" runat="server">
    <title>Registro de Excedentes</title>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-append">
                                <asp:TextBox runat="server" ID="txtMnemonico" Width="150px" ReadOnly="false" />
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            Moneda</label>
                        <div class="col-sm-8">
                            <asp:TextBox runat="server" ID="txtMoneda" Width="250px" ReadOnly="true" />
                        </div>
                    </div>
                </div>
