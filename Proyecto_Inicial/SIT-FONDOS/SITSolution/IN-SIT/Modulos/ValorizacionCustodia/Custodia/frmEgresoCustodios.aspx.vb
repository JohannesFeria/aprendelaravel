...
Partial Class Modulos_Valorizacion_y_Custodia_Custodia_frmEgresoCustodios
    Inherits BasePage
...
#Region "/* Métodos de la Página */"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If Not Page.IsPostBack Then
                ...
                Call CargaPortafolio()
                Call CargaCustodios()
                tbFechaOperacion.Text = oUtil.RetornarFechaSistema
                btnAceptar.Attributes.Add("onclick", "return confirm('" & ObtenerMensaje("CONF10", "Excedentes") & "');")
            Else
    ...
    Private Sub dlFondo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dlFondo.SelectedIndexChanged
        Try
            EstablecerFecha()
        Catch ex As Exception
            AlertaJS("Ocurrió un error el Seleccionar")
        End Try        
    End Sub
...
#Region " /* Funciones Personalizadas*/"
    ...
    Private Function RecuperaSaldosInstrumento(ByVal CodigoSBS As String, ByVal CodigoPortafolioSBS As String, ByVal CodigoCustodio As String, ByVal sFechaOperacion As String) As Boolean
        Dim oValores As New ValoresBM
        Dim oValoresBE As DataSet = oValoresBM.RecuperaSaldosInstrumento(CodigoSBS, CodigoPortafolioSBS, CodigoCustodio, UIUtility.ConvertirFechaaDecimal(sFechaOperacion), DatosRequest)
        ...
        If oValoresBE.Tables(0).Rows.Count > 0 Then
            ...
            If oValoresBE.Tables(0).Rows(0).Item("CodigoCustodioInf") <> "" Then
                ...
                txtCantidadUnidades.Text = String.Format("{0:0.0000000}", (oValoresBE.Tables(0).Rows(0).Item("SaldoInicialUnidades") - oValoresBE.Tables(0).Rows(0).Item("SaldoContable")))
            Else
    ...
    Private Sub CargarGrilla()
        ...
        oInfCusDS = oCustodioAjusteBM.Listar(dlFondo.SelectedValue.Trim, ddlCustodio.SelectedValue.Trim, txtSBS.Text, "E", DatosRequest).Tables(0)
    ...
    Private Function SeleccionarInstrumentoPorCodigoSBS(ByVal sCodigoSBS As String) As String
        Dim oValoresBE As DataSet = oValoresBM.SeleccionarInstrumentoPorCodigoSBS(sCodigoSBS, DatosRequest)

        If oValoresBE.Tables(0).Rows.Count > 0 Then
            sCodigoMoneda = oValoresBE.Tables(0).Rows(0).Item("CodigoMoneda")
        Else
            Return ""
            Exit Function
        End If
    ...
    Private Function Validar() As Boolean
        ...
        ElseIf txtCantidadUnidades.Text.Trim = "" Then
            ...
            Return False
            Exit Function
        ElseIf ViewState("vsInformacionCustodio") = False Then
            AlertaJS(ObtenerMensaje("ALERT96"))
            Return False
            Exit Function
            '--------------------------
        ElseIf Not VerificaRelacionInstrumentoCustodio(txtMnemonico.Text.Trim, dlFondo.SelectedValue.Trim, ddlCustodio.SelectedValue.Trim) Then
            ...
            Exit Function
            '----------------------------
        ElseIf (System.Convert.ToDecimal(txtSaldoSistema.Text.Trim & "0") - System.Convert.ToDecimal(txtSaldoCustodio.Text.Trim & "0")) <> System.Convert.ToDecimal(txtCantidadUnidades.Text.Trim & "0") Then
