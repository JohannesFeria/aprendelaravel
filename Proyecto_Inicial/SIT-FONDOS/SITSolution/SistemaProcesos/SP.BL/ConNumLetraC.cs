/*
 * Fecha de Modificación: 07/08/2015
 * Modificado por: Robert Castillo
 * Numero de OT: 7349
 * Descripción del cambio: Se agregó el parámetro strTipoComprobante en el método Convertir.
 * */
/*
 * Fecha de Modificación: 26/08/2015
 * Modificado por: Juan Castro
 * Numero de OT: 7584
 * Descripción del cambio: Se cambia de ubicación la clase.
 * */
using System;
...
namespace con_NumLetraC
{
    public partial class NumLetra
    {
        ...
        public String Convertir(String numero, String moneda, bool mayusculas, string strTipoComprobante)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                //if (strTipoComprobante.CompareTo(ConstantesING.TIPO_DOCUMENTO_BOLETA) == 0)
                //{
